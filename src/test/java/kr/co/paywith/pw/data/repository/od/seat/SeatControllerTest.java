...
//					 .build();
	 ...
	 public void getSeats() throws Exception {
		  // Given
		  //  IntStream.range(0, 30).forEach(this::generateSeat);
		  ...
		  this.mockMvc.perform(get("/api/seat")
					 ...
					 .andExpect(jsonPath("_embedded.seatList[0]._links.self").exists())
					 .andExpect(jsonPath("_links.self").exists())
					 .andExpect(jsonPath("_links.profile").exists())
					 .andDo(document("query-seats"))
		  ;
	 }
	 ...
	 public void getSeat() throws Exception {
		  // Given
		  //  Seat seat = this.generateSeat(100);

		  // When & Then
		  this.mockMvc.perform(get("/api/seat/{id}", 1)
					 .header("Origin", "*")
					 .header(HttpHeaders.AUTHORIZATION, getBearerToken(true))
		  )
					 .andDo(print())
	 ...
	 public void updateSeat() throws Exception {
		  ...
		  // When & Then
		  this.mockMvc.perform(put("/api/seat/{id}", seat.getId())
					 .header(HttpHeaders.AUTHORIZATION, getBearerToken(true))
					 .header("Origin", "*")

					 .contentType(MediaType.APPLICATION_JSON_UTF8)
					 .content(this.objectMapper.writeValueAsString(seat)))
					 .andDo(print())
					 .andExpect(status().isOk())
					 .andExpect(jsonPath("_links.self").exists())
					 .andDo(document("update-seat"))
		  ;
	 }
