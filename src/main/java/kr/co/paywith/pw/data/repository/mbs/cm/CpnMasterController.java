...
public class CpnMasterController extends CommonController {
  ...
  public ResponseEntity createCpnMaster(
    ...
    ControllerLinkBuilder selfLinkBuilder = linkTo(CpnMasterController.class)
        .slash(newCpnMaster.getId());
    ...
    cpnMasterResource
        .add(new Link("/docs/index.html#resources-cpnMaster-create").withRel("profile"));
...
//        User princpal = (User) authentication.getPrincipal();
  ...
  public ResponseEntity putCpnMaster(@PathVariable Integer id,
    ...
    cpnMasterResource
        .add(new Link("/docs/index.html#resources-cpnMaster-update").withRel("profile"));
