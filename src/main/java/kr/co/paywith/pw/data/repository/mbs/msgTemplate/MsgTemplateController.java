...
public class MsgTemplateController extends CommonController {
	 ...
	 public ResponseEntity createMsgTemplate(
		  ...
		  ControllerLinkBuilder selfLinkBuilder = linkTo(MsgTemplateController.class).slash(newMsgTemplate.getId());
		  ...
		  msgTemplateResource.add(new Link("/docs/index.html#resources-msgTemplate-create").withRel("profile"));
...
//		  User princpal = (User) authentication.getPrincipal();
	 ...
	 public ResponseEntity getMsgTemplate(@PathVariable Integer id,
		  ...
		  msgTemplateResource.add(new Link("/docs/index.html#resources-msgTemplate-get").withRel("profile"));
	 ...
	 public ResponseEntity putMsgTemplate(@PathVariable Integer id,
		  ...
		  MsgTemplate saveMsgTemplate = this.msgTemplateService.update(msgTemplateUpdateDto, existMsgTemplate);

		  // Hateoas 관련 클래스를 이용하여 필요한 링크 정보 추가
		  MsgTemplateResource msgTemplateResource = new MsgTemplateResource(saveMsgTemplate);
		  msgTemplateResource.add(new Link("/docs/index.html#resources-msgTemplate-update").withRel("profile"));
