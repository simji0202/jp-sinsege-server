...
public class CpnIssuRuleController extends CommonController {
  ...
  public ResponseEntity createCpnIssuRule(
    ...
    // 현재 로그인 유저 설정
    if (currentUser != null) {
      cpnIssuRule.setCreateBy(currentUser.getAccountId());
      cpnIssuRule.setUpdateBy(currentUser.getAccountId());
    }
    ...
    cpnIssuRuleResource
        .add(new Link("/docs/index.html#resources-cpnIssuRule-create").withRel("profile"));
...
//        User princpal = (User) authentication.getPrincipal();
  ...
  public ResponseEntity getCpnIssuRule(@PathVariable Integer id,
    ...
    cpnIssuRuleResource
        .add(new Link("/docs/index.html#resources-cpnIssuRule-get").withRel("profile"));
  ...
  public ResponseEntity putCpnIssuRule(@PathVariable Integer id,
    ...
    // 현재 로그인 유저 설정
    if (currentUser != null) {
      existCpnIssuRule.setUpdateBy(currentUser.getAccountId());
    }
    ...
    cpnIssuRuleResource
        .add(new Link("/docs/index.html#resources-cpnIssuRule-update").withRel("profile"));
