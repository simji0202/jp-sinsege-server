...
public class PointRsrvRuleController extends CommonController {
	 ...
	 public ResponseEntity createPointRsrvRule(
		  ...
		  pointRsrvRuleResource.add(new Link("/docs/index.html#resources-pointRsrvRule-create").withRel("profile"));
...
//		  User princpal = (User) authentication.getPrincipal();
		  ...
		  pagedResources.add(new Link("/docs/index.html#resources-pointRsrvRules-list").withRel("profile"));
	 ...
	 public ResponseEntity getPointRsrvRule(@PathVariable Integer id,
		  ...
		  pointRsrvRuleResource.add(new Link("/docs/index.html#resources-pointRsrvRule-get").withRel("profile"));
	 ...
	 public ResponseEntity putPointRsrvRule(@PathVariable Integer id,
		  ...
		  pointRsrvRuleResource.add(new Link("/docs/index.html#resources-pointRsrvRule-update").withRel("profile"));
