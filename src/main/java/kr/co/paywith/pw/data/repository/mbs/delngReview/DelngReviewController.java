...
public class DelngReviewController extends CommonController {
	 ...
	 public ResponseEntity createDelngReview(
		  ...
		  ControllerLinkBuilder selfLinkBuilder = linkTo(DelngReviewController.class).slash(newDelngReview.getId());
		  ...
		  delngReviewResource.add(new Link("/docs/index.html#resources-delngReview-create").withRel("profile"));
...
//		  User princpal = (User) authentication.getPrincipal();
	 ...
	 public ResponseEntity getDelngReview(@PathVariable Integer id,
		  ...
		  delngReviewResource.add(new Link("/docs/index.html#resources-delngReview-get").withRel("profile"));
	 ...
	 public ResponseEntity putDelngReview(@PathVariable Integer id,
		  ...
		  DelngReview saveDelngReview = this.delngReviewService.update(delngReviewUpdateDto, existDelngReview);

		  // Hateoas 관련 클래스를 이용하여 필요한 링크 정보 추가
		  DelngReviewResource delngReviewResource = new DelngReviewResource(saveDelngReview);
		  delngReviewResource.add(new Link("/docs/index.html#resources-delngReview-update").withRel("profile"));
